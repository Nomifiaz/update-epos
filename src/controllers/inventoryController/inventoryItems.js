import { InventoryItem, InventoryCatagory, Units } from '../../models/inventeryRelations.js'
...
export const updateInventoryItem = async (req, res) => {
  try {
    const { id } = req.params
    const { name, code, categoryId, minQty, purchaseUnitId, saleUnitId, lastPurchasePrice } =
      req.body
